...
class AppGloss {
  ...
  static const List<BoxShadow> soft = [
    ...
    BoxShadow(color: Color(0x0F6A1B9A), blurRadius: 3, offset: Offset(0, 1)),
  ];

  /// Stronger lift for hero cards, sheets and floating actions.
  static const List<BoxShadow> lifted = [
    BoxShadow(color: Color(0x1F4A0D52), blurRadius: 28, offset: Offset(0, 14)),
    BoxShadow(color: Color(0x14000000), blurRadius: 8, offset: Offset(0, 2)),
  ];

  /// Coloured glow under a glossy primary button.
  static const List<BoxShadow> buttonGlow = [
    BoxShadow(color: Color(0x386A1B9A), blurRadius: 18, offset: Offset(0, 10)),
  ];
