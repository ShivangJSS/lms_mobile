...
class AppGloss {
  ...
  static const List<BoxShadow> soft = [
    ...
    BoxShadow(color: Color(0x0F6A11CB), blurRadius: 3, offset: Offset(0, 1)),
  ];

  /// The white plate the logo sits on: blur 20, spread 2, dropped 8.
  static const List<BoxShadow> plate = [
    BoxShadow(
      color: Color(0x33230A46),
      blurRadius: 20,
      spreadRadius: 2,
      offset: Offset(0, 8),
    ),
  ...
  /// Coloured glow under a glossy primary button.
  static const List<BoxShadow> buttonGlow = [
    BoxShadow(color: Color(0x598E2DE2), blurRadius: 22, offset: Offset(0, 10)),
  ];
